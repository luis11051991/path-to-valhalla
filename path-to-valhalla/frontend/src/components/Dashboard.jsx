    ...
    const GlobalTooltip = () => {
        ...
        return (
            <div style={style} className={`bg-slate-950 border-2 p-3 rounded shadow-[0_0_30px_rgba(0,0,0,0.9)] min-w-[200px] pointer-events-none animate-in fade-in zoom-in-95 duration-100 ${styles.border} ${styles.glow}`}>
                ...
                <p className="text-[10px] text-slate-500 uppercase tracking-widest mb-2 border-b border-white/10 pb-1">{item.type} â€¢ {item.rarity}</p>
                ...
                <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-4 items-start animate-in fade-in duration-300">
                    <div className="lg:col-span-3 space-y-4">
                        ...
                        <div className="bg-black/50 backdrop-blur-sm border border-slate-700 rounded p-3 text-xs space-y-2">
                            ...
                            <div className="flex justify-between items-center border-b border-white/5 pb-1"><span className="text-slate-400 flex items-center gap-2"><img src={STAT_IMAGES.health} className="w-5 h-5"/> Salud Max</span><span className="text-red-400 font-mono">{user.current_hp} / {derivedStats.maxHp}</span></div>
